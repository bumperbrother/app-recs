  ...
  return (
    <div className="w-full max-w-7xl mx-auto">
      ...
      >
        ...
        />
        <g className="pyramid-section" onClick={() => handleSectionClick('toppings')}>
          <text 
            x="480" 
            y="160" 
            textAnchor="middle" 
        ...
        />
        <g className="pyramid-section" onClick={() => handleSectionClick('service-line')}>
          <text 
            x="480" 
            y="235" 
            textAnchor="middle" 
        ...
        />
        <g className="pyramid-section" onClick={() => handleSectionClick('engagement')}>
          <text 
            x="480" 
            y="310" 
            textAnchor="middle" 
        ...
        {/* Tax Workflow & Close Automation - Fourth level (rectangles) */}
        <path
        ...
        />
        <g className="pyramid-section" onClick={() => handleSectionClick('tax-workflow')}>
          <text 
            x="378" 
            y="385" 
            textAnchor="middle" 
        ...
        />
        <g className="pyramid-section" onClick={() => handleSectionClick('close-automation')}>
          <text 
            x="582" 
            y="385" 
            textAnchor="middle" 
        ...
        />
        <g className="pyramid-section" onClick={() => handleSectionClick('practice-management')}>
          <text 
            x="480" 
            y="478" 
            textAnchor="middle" 
        ...
        {/* Tax Preparation & Ledger - Foundation level (rocket boosters) */}
        <path
        ...
        />
        <g className="pyramid-section" onClick={() => handleSectionClick('tax-preparation')}>
          <text 
            x="336" 
            y="555" 
            textAnchor="middle" 
        ...
        />
        <g className="pyramid-section" onClick={() => handleSectionClick('ledger')}>
          <text 
            x="624" 
            y="555" 
            textAnchor="middle" 
